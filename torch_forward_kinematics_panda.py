...
class Torch_fwd_kinematics_Panda:
    def __init__(self) -> None:
        self.panda_chain = pk.build_serial_chain_from_urdf(open("/home/jayaram/miniconda3/envs/planning_diffuser/lib/python3.8/site-packages/pybullet_data/franka_panda/panda.urdf").read(), "panda_rightfinger")# "panda_hand") -- Panda hand is right!
    ...
    def get_batch_differential_forward_kinematics(self, qBatch):
        ...
        link_poses = {}
        for key in tg.keys():
            link_poses[key] = tg[key].get_matrix()     #B*4*4   (we now have link positions i.w world2link for all 10 links in current batch of conf) 
...
if __name__=="__main__":
    ...
    dPanda = Torch_fwd_kinematics_Panda()